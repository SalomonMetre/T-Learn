...
$trainees = $userModel->getUsersWhere(['Type' => 'Trainee']);
$appointments = $appointmentModel->getAppointmentsOrWhere(['ToId' => session('trainer')['UserId']], ['ProposedById' => session('trainer')['UserId']]);
            ...
            <div class="col-md-3" style="background-color: #005149;text-align:center;">
                <div class="container-fluid">
                    ...
                    <div class="row" style="background-color: #222A2A; margin-right:-10%; margin-left:-10%;">>
                        <div style="color:white; margin:1em; padding:0.3em; font-size:1.5em;"> <a href="<?= base_url('TrainerShowPage/Appointments') ?>" style="text-decoration: none; color:yellow;"> <i class="bi bi-calendar"></i> Appointments </a> </div>
                    </div>
                    <div class="row">
                ...
                <div class="modal fade" id="addAppointmentId" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="<?= base_url('TrainerAddAppointment/') ?>" method="POST">
                                <div class="modal-body">
                                    ...
                                    <div class="form-floating mb-3">
                                        <h6 style="color:green; padding-left:3%; padding-right:3%;"> Select trainee </h6>
                                        <select name="ToId" id="" style="padding:3%; width:100%;">
                                            <?php
                                            if ($trainees) {
                                                foreach ($trainees as $trainee) {
                                            ?>
                                                    <option value="<?= $trainee['UserId'] ?>"> <?= $trainee['FirstName'] . ' ' . $trainee['LastName'] ?> </option>
                                            <?php
                                                }
                                            }
                                            ?>
                                            ...
                                            <div class="modal fade" id="editApptId<?= $appointment['AppointmentId'] ?>" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="<?= base_url('TrainerUpdateAppointment/') ?>" method="POST">
                                                            <div class="modal-body">
