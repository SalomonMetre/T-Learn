...
$registrations = $registrationModel->getRegistrationsWhere(['Status<>' => 'Approved']);
            ...
            <div class="col-md-3" style="background-color: #005149;text-align:center;">
                <div class="container-fluid">
                    ...
                    <div class="row" style="background-color: #222A2A; margin-right:-10%; margin-left:-10%;">
                        <div style="color:white; margin:1em; padding:0.3em; font-size:1.5em;"> <a href="<?= base_url('AdminShowPage/UnitRegistrations') ?>" style="text-decoration: none; color:yellow;"> <i class="bi bi-card-checklist"></i> Unit Registrations </a> </div>
                    </div>
                    <div class="row">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td> <?= $registration['UnitId'] ?></td>
                                    <td> <?= $registration['TraineeId'] ?></td>
                                    <td> <?= $registration['Status'] ?></td>
                                    <td> <?= $registration['Time'] ?></td>
                                    <td>
                                        <!-- Button trigger modal -->
                                        <button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#editCourseId<?= $registration['RegistrationId'] ?>">
                                            Edit
                                        </button>

                                        <!-- Modal -->
                                        <div class="modal fade" id="editCourseId<?= $registration['RegistrationId'] ?>" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="<?= base_url('AdminUpdateRegistration/') ?>" method="POST">
                                                        <div class="modal-body">
                                                            <input type="text" name="RegistrationId" value="<?= $registration['RegistrationId'] ?>" hidden>
                                                            <select name="NewStatus" id="" style="width:100%;padding:1em;">
