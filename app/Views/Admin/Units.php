        ...
        <div class="row">
            <div class="col-md-3" style="background-color: #005149;text-align:center;">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div style="color:white; margin:1em; padding:0.3em; font-size:1.5em;"> <a href="<?= base_url('AdminShowPage/Courses') ?>" style="text-decoration: none; color:white;"> <i class="bi bi-book-fill"></i> Course </a> </div>
                    </div>
                    <div class="row" style="background-color: #222A2A; margin-right:-10%; margin-left:-10%;">
                        <div style="color:white; margin:1em; padding:0.3em; font-size:1.5em;"> <a href="<?= base_url('AdminShowPage/Units') ?>" style="text-decoration: none; color:yellow;"> <i class="bi bi-journal-album"></i> Units </a> </div>
                    </div>
                    <div class="row">
            ...
            <div class="col-md-9">
                ...
                <button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#addunitId" style="width:90%;margin-left:3em; margin-right:3em; margin-top:2em; margin-bottom:2em;">
                    Add unit
                </button>

                <!-- Modal -->
                <div class="modal fade" id="addunitId" tabindex="-1" role="dialog" aria-labelledby="modelId" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" style="color:black;"> Add unit </h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <form action="<?= base_url('AdminAddUnit/') ?>" method="POST">
                                <div class="modal-body">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" name="CourseId" id="Label" placeholder="" required>
                                        <label for="floatingLabel"> Course Id</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" name="TrainerId" id="Label" placeholder="" required>
                                        <label for="floatingLabel"> Trainer Id </label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" name="UnitName" id="Label" placeholder="" required>
                                        <label for="floatingLabel"> Unit Name </label>
                                    </div>
                                    <div class="form-floating mb-3">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <!-- Button trigger modal -->
                                        <button type="button" class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#editUnitId<?= $unit['UnitId'] ?>">
                                            Edit
                                        </button>
                                        <!-- Modal -->
                                        <div class="modal fade" id="editUnitId<?= $unit['UnitId'] ?>" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" style="color:black;"> Update Unit </h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <form action="<?= base_url('AdminUpdateUnit/') ?>" method="POST">
                                                        <div class="modal-body">
                                                            <input type="text" name="UnitId" value="<?= $unit['UnitId'] ?>" hidden>
                                                            <div class="form-floating mb-3">
                                                                <input type="text" class="form-control" name="CourseId" id="Label" value="<?= $unit['CourseId'] ?>" placeholder="" required>
                                                                <label for="floatingLabel"> Course Id </label>
                                                            </div>
                                                            <div class="form-floating mb-3">
                                                                <input type="text" class="form-control" name="UnitName" id="Label" value="<?= $unit['UnitName'] ?>" placeholder="" required>
                                                                <label for="floatingLabel"> Unit Name </label>
                                                            </div>
                                                            <div class="form-floating mb-3">
                                                                <input type="text" class="form-control" name="Description" id="Label" value="<?= $unit['Description'] ?>" placeholder="" required>
                                                                <label for="floatingLabel"> Description </label>
                                                            </div>
                                                            <div class="form-floating mb-3">
                                                                <input type="text" class="form-control" name="Duration" id="Label" value="<?= $unit['Duration'] ?>" placeholder="" required>
                                                                <label for="floatingLabel"> Duration </label>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
