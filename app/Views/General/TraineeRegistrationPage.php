...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('Css/General/TrainerRegistration.css') ?>">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-success" style="padding:1em;">
            ...
            <div class="navbar-collapse" id="main_nav">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="<?= base_url('TraineeShowPage/Login') ?>"> <i class="bi bi-box-arrow-in-right"></i> Login </a> </li>
                </ul>
            </div>
        </nav>
        <div class="row" style="color:white; padding:3em 10em 10em 10em;">
            <form action="<?= base_url('TraineeRegister/') ?>" method="POST" style="padding-left:20%; padding-right:20%; text-align:center;">
                <h3> Register </h3>
                <div class="form-floating mb-3">
                  <input
                    type="text"
                    class="form-control" name="FirstName" id="Label" placeholder="" required>
                  <label for="floatingLabel"> First Name </label>
                </div>
                <div class="form-floating mb-3">
                  <input
                    type="text"
                    class="form-control" name="LastName" id="Label" placeholder="" required>
                  <label for="floatingLabel"> Last Name </label>
                </div>
                <div class="form-floating mb-3">
                  <input
                    type="email"
                    class="form-control" name="Email" id="Label" placeholder="" required>
                  <label for="floatingLabel"> Email </label>
                </div>
                <div class="form-floating mb-3">
                  <input
                    type="password"
                    class="form-control" name="Password" id="Label" placeholder="" required>
                  <label for="floatingLabel"> Password </label>
                </div>
                <div class="form-floating mb-3">
                  <input
                    type="password"
                    class="form-control" name="ConfPassword" id="Label" placeholder="" required>
                  <label for="floatingLabel"> Confirm Password </label>
                </div>
                <div class="form-floating mb-3">
                  <input
                    type="text"
                    class="form-control" name="Skills" id="Label" placeholder="">
