        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-success" style="padding:1em;">
            ...
            <div class="navbar-collapse" id="main_nav">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="<?= base_url('TrainerShowPage/Login') ?>"> <i class="bi bi-box-arrow-in-right"></i> Login </a> </li>
                </ul>
            </div>
        </nav>
        <div class="row" style="color:white; padding:3em 10em 10em 10em;">
            <form action="<?= base_url('TrainerRegister/') ?>" method="POST" style="padding-left:20%; padding-right:20%; text-align:center;">
                <h3> Register </h3>
