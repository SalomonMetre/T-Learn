...
<body>
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-3" style="background-color: #005149;text-align:center;">
                <div class="container-fluid">
                    <div class="row" style="background-color: #222A2A; margin-right:-10%; margin-left:-10%;">
                        <div style="color:white; margin:1em; padding:0.3em; font-size:1.5em;"> <a href="<?= base_url('TraineeShowPage/Home') ?>" style="text-decoration: none; color:yellow;"> <i class="bi bi-person-lines-fill"></i> Profile </a> </div>
                    </div>
                    <div class="row">
            ...
            <div class="col-md-9">
                <form action="<?= base_url('TraineeUpdate/') ?>" method="POST" style="padding-left:20%; padding-right:20%; text-align:center; margin-top:3em;">
                <button class="btn btn-primary" style="width:90%;margin-left:3em; margin-right:3em; margin-top:1em; margin-bottom:2em;"> Update Profile </button>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="FirstName" id="Label" placeholder="" value="<?= session()->get('trainee')['FirstName'] ?>" required>
                        <label for="floatingLabel"> First Name </label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="LastName" id="Label" placeholder="" value="<?= session()->get('trainee')['LastName'] ?>" required>
                        <label for="floatingLabel"> Last Name </label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="email" class="form-control" name="Email" id="Label" placeholder="" value="<?= session()->get('trainee')['Email'] ?>" required>
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" name="Skills" id="Label" value="<?= session()->get('trainee')['Skills'] ?>" placeholder="">
