...
$contents = $contentModel->getContentsWhereIn('UnitId', $unitIds);
            ...
            <div class="col-md-3" style="background-color: #005149;text-align:center;">
                <div class="container-fluid">
                    ...
                    <div class="row" style="background-color: #222A2A; margin-right:-10%; margin-left:-10%;">
                        <div style="color:white; margin:1em; padding:0.3em; font-size:1.5em;"> <a href="<?= base_url('TraineeShowPage/Contents') ?>" style="text-decoration: none; color:yellow;"> <i class="bi bi-journal"></i> Contents </a> </div>
                    </div>
                    <div class="row">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" style="color:black;"> New Comment </h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <form action="<?= base_url('TraineePostComment/') ?>" method="POST">
                                                        <div class="modal-body">
                                                            <input type="text" name="ContentId" value="<?= $content['ContentId'] ?>" hidden>
                                                            <div class="form-floating mb-3">
                                                                <input type="text" class="form-control" name="Comment" id="Label" placeholder="">
                                                                <label for="floatingLabel"> Comment </label>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"> Close </button>
                                                            <button type="submit" class="btn btn-primary" data-bs-dismiss="modal"> Post comment </button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
