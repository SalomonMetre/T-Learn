    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12" style="text-align:center; color:white; margin-top:10%;">
                <div style="">
                    Welcome <?= session('trainee')['FirstName'].' '.session('trainee')['LastName']?> !
                </div>
                <h6 style="margin-top:1%; margin-bottom:5%;"> Explore different options offered to you</h6>
                <button class="btn btn-primary"> <a href="<?= base_url('TraineeShowPage/Home') ?>" style="text-decoration:none; color:white;"> Click here to get started </a> </button>
            </div>
        </div>
    </div>
    <script>
